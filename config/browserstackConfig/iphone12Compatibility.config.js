...
exports.config = {
  ...
  commonCapabilities: {
    ...
    'bstack:options': {
      ...
      "local": "true",
      "projectName": "IPC",
      "buildName": "iPhone 12 - IOS Compatibility",
      "sessionName": "IPC iphone 12 IOS Compatibility - " + date + ", " + startTime,
      "debug": "true",
      "consoleLogs": "verbose",
      "networkLogs": "true",
      "idleTimeout": 120,
  ...
  capabilities: [
    //Chrome currently not available via browserstack
    // {
    //   browserName: "chrome",
    //   "cjson:metadata": {
    //     browser: {
