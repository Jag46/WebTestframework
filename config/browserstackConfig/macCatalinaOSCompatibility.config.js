...
exports.config = {
  ...
  deviceUnderTest: 'macCatalina',

  serverUrls: {
    environment: process.env.testEnvironment || "dev4"
  },

  specs: [process.env.testSpecs || 'test/features/GUI/4.yourTaxPage/yourTaxPage.feature'],
  ...
  commonCapabilities: {
    'bstack:options': {
      ...
      "local": "true",
      "projectName": "IPC",
      "buildName": "Catalina - Mac Compatibility",
      "sessionName": "IPC Mac Catalina OS Compatibility - " + date + ", " + startTime,
      "debug": "true",
      "consoleLogs": "verbose",
      "networkLogs": "true",
      "idleTimeout": 90
