...
exports.config = {
  ...
  deviceUnderTest: 'macBigSur',

  serverUrls: {
    environment: process.env.testEnvironment || "dev4"
  },

  specs: [process.env.testSpecs || 'test/features/Sprints/Sprint_33/CAO-10507.feature'],
  ...
  commonCapabilities: {
    'bstack:options': {
      ...
      "local": "true",
      "projectName": "IPC",
      "buildName": "Big Sur - Mac Compatibility",
      "sessionName": "IPC Mac Big Sur OS Compatibility - " + date + ", " + startTime,
      "debug": "true",
      "consoleLogs": "verbose",
      "networkLogs": "true",
      "idleTimeout": "90",
