...
exports.config = {
  ...
  specs: ['test/features/API/2.Apigee/1.TokenHandlerExchange.feature'],
  ...
  commonCapabilities: {
    'bstack:options': {
      ...
      "projectName": "IPC",
      "buildName": "Test",
      "sessionName": "IPC [browserStack] - " + date + ", " + startTime,
      "debug": "true",
      "consoleLogs": "verbose",
      "networkLogs": "true",
      "idleTimeout": 90
...
key: "",
  ...
  onComplete: function() {
    ...
    generate({
      ...
      pageFooter: "<div><p style=text-align:center;> Internal Product Change</p></div>",
      reportName: "<h2><div><p style=text-align:center;>Internal Product Change - " + reportName + " Automation Test Report</p></div><h2>",

      customData: {
        title: "Execution Summary Details",
        data: [
          { label: "Project", value: "Internal Product Change" },
