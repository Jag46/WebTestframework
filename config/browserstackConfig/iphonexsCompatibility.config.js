...
exports.config = {
  ...
  deviceUnderTest: 'iPhoneXS',

  serverUrls: {
    environment: process.env.testEnvironment || "dev4"
  },

  specs: [process.env.testSpecs || 'test/features/GUI/3.aboutYouPage/aboutYouPage.feature'],
  ...
  commonCapabilities: {
    ...
    'bstack:options': {
      ...
      "local": "true",
      "projectName": "IPC",
      "buildName": "iPhone XS - IOS Compatibility",
      "sessionName": "IPC iphone XS IOS Compatibility - " + date + ", " + startTime,
      "debug": "true",
      "consoleLogs": "verbose",
      "networkLogs": "true",
      "idleTimeout": 120,
