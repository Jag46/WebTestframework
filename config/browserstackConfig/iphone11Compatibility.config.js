...
exports.config = {
  ...config,
  deviceUnderTest: 'iPhone11',
  serverUrls: {
    environment: process.env.testEnvironment || "dev4"
  },

  specs: [process.env.testSpecs || 'test/features/Sprints/Sprint_28/CAO-11218.feature'],
  ...
  commonCapabilities: {
    ...
    'bstack:options': {
      ...
      "local": "true",
      "projectName": "IPC",
      "buildName": "iPhone 11 - IOS Compatibility",
      "sessionName": "IPC iphone 11 IOS Compatibility - " + date + ", " + startTime,
      "debug": "true",
      "consoleLogs": "verbose",
      "networkLogs": "true",
      "idleTimeout": 120,
